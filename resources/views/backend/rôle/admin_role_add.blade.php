...
<div class="container-full">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">@if (session()->get('language') == 'english')Create Admin User @else Nouveau Administrateur @endif </h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
	 <form method="post" action="{{ route('admins_roles_store') }}" enctype="multipart/form-data" >
	 	@csrf
	...
	<div class="row">
	  ...
	  <div class="form-group">
		<h5>@if (session()->get('language') == 'english')Admin Password @else Mot De Passe @endif  <span class="text-danger">*</span></h5>
		<div class="controls">
 ...
 <input type="file" name="profile_photo_path" class="form-control" required="" id="image"> </div>
				...
				<div class="col-md-6">
	<img id="showImage" src="{{ url('upload/no_image.png') }}" style="width: 100px; height: 100px;">				
...
<div class="col-md-4">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_2" name="category" value="1">
				<label for="checkbox_2">@if (session()->get('language') == 'english')Category @else Categorie @endif</label>
			</fieldset>

            <fieldset>
				<input type="checkbox" id="checkbox_3" name="subcategory" value="1">
...
<div class="col-md-4">
		...
		<div class="controls">
            <fieldset>
				<input type="checkbox" id="checkbox_8" name="coupons" value="1">
				<label for="checkbox_8">Coupons</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_9" name="shipping" value="1">
				<label for="checkbox_9">@if (session()->get('language') == 'english')Shipping @else Expédition @endif</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_10" name="blog" value="1">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_12" name="returnorder" value="1">
				<label for="checkbox_12">@if (session()->get('language') == 'english')Return Order @else Retour Commande @endif</label>
			</fieldset>

			<fieldset>
				<input type="checkbox" id="checkbox_13" name="review" value="1">
