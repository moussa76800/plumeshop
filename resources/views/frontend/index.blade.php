                  ...
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    @foreach ($books as $book)
                      ...
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            <div class="image"><a href="{{ url('book/detail/'.$book->id.'/'.$book->name_en ) }}"> @if(session()->get('language') == 'french') {{ $book->name_fr }} @else {{ $book->name_en }} @endif<img src="{{  asset($book->product_thambnail) }}"></a></div>
                            <!-- /.image -->
                    ...
                    @endphp
                      ...
                      <div class="item item-carousel">
                        <div class="products">
                          <div class="product">
                            <div class="product-image">
                              <div class="image"> <a href="detail.html"><img  src="{{ $book->product_thambnail }}" alt=""></a> </div>
                              <!-- /.image -->
