        ...
        <div class="product">
          ...
          <div class="product-info text-left">
            ...
            <div class="product-price"> <span class="price">@if (session()->get('language') == 'french') € {{ $product->prix }} @else $ {{ $product->prix }} @endif </span> </div>
                    @else
            <div class="product-price"> <span class="price">@if (session()->get('language') == 'french') € {{ $product->prix - $product->discount_price }} </span> <span class="price-before-discount">  €  {{ $book->prix }}</span> @else
