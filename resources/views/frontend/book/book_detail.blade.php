...
<div class="product-item-holder size-big single-product-gallery small-gallery">
	...
	<div id="owl-single-product">
		...
		<div class="single-product-gallery-item" id="slide{{ $multiImg->id }}">
			<a data-lightbox="image-1" data-title="Gallery" href="{{asset($multiImg->photo_name) }}">
				<img class="img-responsive" alt="" src="{{asset($multiImg->photo_name) }}" data-echo="{{asset($multiImg->photo_name) }}" />
			</a>
