	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="#">@if (session()->get('language') == 'french')Home @else Accueil @endif</a></li>
...
<div class="body-content">
	...
	<p>@if(session()->get('language') == 'french') {!! Str::limit($blog->post_details_fr, 240 )  !!} @else {!! Str::limit($blog->post_details_en, 240 )  !!} @endif</p>
                        ...
                        <br>
	<a href="" class="btn btn-upper btn-primary read-more">@if(session()->get('language') == 'french')Lire plus @else read more @endif</a>
    {{-- {{ route('post.details',$blog->id) }} --}}
